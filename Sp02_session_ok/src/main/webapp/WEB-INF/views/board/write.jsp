...
<head>
<meta charset="utf-8">
<title>Spring Board - Write</title>
<style>
a {
...
<body onload="input.writer.focus()">
	<font color="gray" size='4' face="휴먼편지체">
		<center>
			...
			<h3>Spring Board - Write</h3>
			<font color="gray" size="3" face="휴먼편지체"> <a href='list.do'>리스트</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='/'>인덱스</a>
			</font>
			<hr width="600" size="2" color="gray" noshade>
		</center>
		...
		<form name="input" method="post" action="write.do">
			<table border="0" width="600" align="center" cellpadding="3" cellspacing="1" bordercolor="gray">
				...
				<tr>
					<td colspan="2" align="center"><input type="button" value="전송" onclick="check()"> <input type="reset" value="다시입력" onclick="input.writer.focus()"></td>
				</tr>
			</table>
			<hr width="600" size="2" color="gray" noshade>
		</form>
