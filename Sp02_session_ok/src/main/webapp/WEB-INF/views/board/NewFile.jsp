...
<body>
	<center>
		<font color='gray' size='4' face='휴먼편지체'>
			...
			<h3>Spring Board - List</h3> <font color='gray' size='4' face='휴먼편지체'> <a href='../'>인덱스</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='write.do'>글쓰기</a><br />
		</font>
			<hr width='600' size='2' color='gray' noshade>
        ...
        <a href="list.do?cp=3">
    	 ...
    	 --> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select id="psId" name="ps" onchange="f(this)">
					...
					<option value="desc" <c:if test="${orderBy eq 'desc'}">selected</c:if>>최신순</option>
					<option value="asc" <c:if test="${orderBy eq 'asc'}">selected</c:if>>오래된순</option>
			</select> <script language="javascript">
				function changeOrderBy(select) {
					var ps = document.getElementById("psId").value;
					console.log("ps:" + ps);
					orderBy = select.value;
					location.href = "list.do?ps=" + ps + "&orderBy=" + orderBy;
